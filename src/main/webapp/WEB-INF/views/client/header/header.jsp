                        ...
                        <div class="col-lg-6 text-right">
                            <div class="header-top-settings">
                                <ul class="nav align-items-center justify-content-end">
                                    ...
                                    <li class="language">
                                        <img src="<c:url value="/public/assets/img/icon/en.png"/>" alt="flag"> English
                                        <i class="fa fa-angle-down"></i>
                                        <ul class="dropdown-list">
                                            <li><a href="#"><img src="<c:url value="/public/assets/img/icon/en.png"/>" alt="flag"> english</a></li>
                                            <li><a href="#"><img src="<c:url value="/public/assets/img/icon/fr.png"/>" alt="flag"> french</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-2">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="<c:url value="/public/assets/img/logo/logo.png"/>" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- start logo area -->
                            ...
                            <div class="main-menu-area">
                                <div class="main-menu">
                                    ...
                                    <nav class="desktop-menu">
                                        <ul>
                                            <li class="active"><a href="/project">Home</a>
