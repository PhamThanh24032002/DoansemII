						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									<f:form modelAttribute="newSize"
										action="${rootAdmin}sizes/insert">
						...
						<div class="card">
							<div class="card-body">
								<table class="table table-borderless mb-0">
									...
									<tbody>
										<c:forEach items="${sizes}" var="item" varStatus="loop">
											<tr>
												<th scope="row">${loop.index+1}</th>
												<td>${item.value}</td>
												<td><a
													href="${rootAdmin}sizes/init-update?id=${item.id}"><i
														class="bx bxs-edit"></i></a> <a
													href="${rootAdmin}sizes/delete?id=${item.id}"><i
