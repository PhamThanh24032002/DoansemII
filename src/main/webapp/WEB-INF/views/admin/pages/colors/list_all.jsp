								...
								<div class="row align-items-center">
									<div class="col-lg-9 col-xl-10">
										<form class="float-lg-end" method="post"
											action="${rootAdmin}category/search">
											<div class="row row-cols-lg-2 row-cols-xl-auto g-2">
												<div class="col">
													<div class="position-relative">
														<input type="text" name="key" class="form-control ps-5"
															placeholder="Search Any Course..."> <span
						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									<f:form modelAttribute="newColor"
										action="${rootAdmin}colors/insert">
										<div class="card-title d-flex align-items-center">
											<div>
												<i class="bx bxs-user me-1 font-22 text-info"></i>
											</div>
											<h5 class="mb-0 text-info">Add new Color</h5>
										</div>
										<hr />
										<div class="row mb-3">
											<label for="inputEnterYourName"
												class="col-sm-3 col-form-label">Enter Color's Name</label>
											<div class="col-sm-9">
												<f:input type="text" path="name" class="form-control"
													id="inputEnterYourName" placeholder="Enter Cate's Name"></f:input>
										...
										<div class="row mb-3">
											<label for="inputEnterYourName"
												class="col-sm-3 col-form-label">Pick a color</label>
											<div class="col-sm-9">
												<f:input type="color" path="value" class="form-control"
						...
						<div class="card">
							<div class="card-body">
								<table class="table table-borderless mb-0">
									...
									<tbody>
										<c:forEach items="${colors}" var="item" varStatus="loop">
											<tr>
												<th scope="row">${loop.index+1}</th>
												<td>${item.name}</td>
												<td style="background: ${item.value}"></td>
												<td><a
													href="${rootAdmin}colors/init-update?id=${item.id}"><i
														class="bx bxs-edit"></i></a> <a
													href="${rootAdmin}colors/delete?id=${item.id}"><i
							...
							<nav aria-label="Page navigation example"
								...
								<ul class="pagination round-pagination">
									<li class="page-item"><a class="page-link"
										href="${rootAdmin}colors/page/${page-1}">Previous</a></li>
									<c:forEach begin="1" end="${pages}" var="page">
										<li class="page-item"><a class="page-link"
											href="${rootAdmin}colors/page/${page}">${page}</a></li>
									</c:forEach>
									<li class="page-item"><a class="page-link"
										href="${rootAdmin}colors/page/${page+1}">Next</a></li>
								</ul>
							</nav>
						</div>
					</div>
