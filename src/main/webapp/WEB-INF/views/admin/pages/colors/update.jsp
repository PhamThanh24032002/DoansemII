...
<title>Update Color | ${old_color.name}</title>
</head>
<body>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="${rootAdmin}colors"><i
										class="bx bx-home-alt"></i></a></li>
								<li class="breadcrumb-item active" aria-current="page">Update</li>
								<li class="breadcrumb-item active" aria-current="page">${old_color.name}</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<f:form modelAttribute="old_color"
										action="${rootAdmin}colors/update" method="post">
										<f:input path="id" type="hidden"></f:input>
										<div class="card-title d-flex align-items-center">
											<div>
												<i class="bx bxs-user me-1 font-22 text-info"></i>
											</div>
											<h5 class="mb-0 text-info">Update Color</h5>
										</div>
										<hr />
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<f:input type="text" path="name" class="form-control"
													value="${old_color.name}" id="inputEnterYourName"
													placeholder="Enter Cate's Name"></f:input>
