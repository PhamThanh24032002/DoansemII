                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                                <a class="dropdown-item" href="${rootAdmin}banner/init-insert">Add new</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-9 col-xl-10">
                                        <form class="float-lg-end" method="post" action="${rootAdmin}banner/search">
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                        <c:forEach items="${banner}" var="item" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${rootAdmin}banner/init-update?id=${item.id}"><i class="bx bxs-edit"></i></a>
                                                    <a href="${rootAdmin}banner/delete?id=${item.id}"><i class="bx bx-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                            ...
                            <nav aria-label="Page navigation example" class="align-self-center">
                                <ul class="pagination round-pagination">
                                    <li class="page-item" >
                                        <a class="page-link" href="${rootAdmin}banner/page/${page-1}">Previous</a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="page">
                                        <li class="page-item"><a class="page-link" href="${rootAdmin}banner/page/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item"><a class="page-link" href="${rootAdmin}banner/page/${page+1}">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
