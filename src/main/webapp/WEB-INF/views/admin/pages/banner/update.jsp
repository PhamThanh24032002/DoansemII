					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item"><a href="${rootAdmin}banner">Banner</a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Update</li>
								<li class="breadcrumb-item active" aria-current="page">${old_banner.title}</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<f:form modelAttribute="old_banner" method="post"
										action="${rootAdmin}banner/update"
