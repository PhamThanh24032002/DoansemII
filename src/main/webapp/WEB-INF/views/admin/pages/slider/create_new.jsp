                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="${rootAdmin}slider"><i class="bx bx-home-alt"></i></a>
                                </li>
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="newslider" action="${rootAdmin}slider/insert" enctype="multipart/form-data">
                                            <div class="card-title d-flex align-items-center">
                                                <div><i class="bx bxs-user me-1 font-22 text-info"></i>
                                                </div>
                                                <h5 class="mb-0 text-info">Add new Slider</h5>
                                            </div>
                                            <hr/>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Enter Slider Title</label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="title" class="form-control" id="inputEnterYourName" placeholder="Enter Slider Title"></f:input>
                                                    <f:errors path="title" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Enter Slider Content</label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="content_sub" class="form-control" id="inputEnterYourName" placeholder="Enter Slider Content"></f:input>
											...
											<div class="col-sm-9">
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:input type="number" path="position" class="form-control" id="inputEnterYourName" placeholder="Position"></f:input>
                                                    <f:errors path="position" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
