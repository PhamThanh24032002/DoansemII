					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item"><a href="${rootAdmin}course">Slider</a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Update</li>
								<li class="breadcrumb-item active" aria-current="page">${old_slider.title}</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<f:form modelAttribute="old_slider" method="post"
										action="${rootAdmin}slider/update"
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<f:input type="text" path="content_sub" class="form-control"
													id="inputEnterYourTitle" placeholder="Enter content..."></f:input>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<f:input type="number" path="position"
													class="form-control" id="inputEnterYourTitle"
													placeholder="Enter position..."></f:input>
