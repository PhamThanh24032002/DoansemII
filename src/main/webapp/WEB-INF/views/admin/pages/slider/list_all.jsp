                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                                <a class="dropdown-item" href="${rootAdmin}slider/init-insert">Add new</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-9 col-xl-10">
                                        <form class="float-lg-end" method="post" action="${rootAdmin}slider/search">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach items="${slider}" var="item" varStatus="loop">
                                            <tr>
                                                <th scope="row">${loop.index+1}</th>
                                                <td>${item.title}</td>
                                                <td>${item.content_sub}</td>
                                                <td>${item.image}</td>
                                                <td>${item.position}</td>
                                                <td>${item.status==true?"Active":"In active"}</td>
                                                <td>
                                                    <a href="${rootAdmin}slider/init-update?id=${item.id}"><i class="bx bxs-edit"></i></a>
                                                    <a href="${rootAdmin}slider/delete?id=${item.id}"><i class="bx bx-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                            ...
                            <nav aria-label="Page navigation example" class="align-self-center">
                                <ul class="pagination round-pagination">
                                    <li class="page-item" >
                                        <a class="page-link" href="${rootAdmin}slider/page/${page-1}">Previous</a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="page">
                                        <li class="page-item"><a class="page-link" href="${rootAdmin}slider/page/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item"><a class="page-link" href="${rootAdmin}slider/page/${page+1}">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
