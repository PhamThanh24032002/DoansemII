...
<body>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="${rootAdmin}product"><i
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="file" name="fileImg" class="form-control" /> <span
													type="text" style="color: red;">${blankImg}</span>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-6">
										...
										<div class="row mb-5">
											...
											<div class="form-check">
												<f:radiobutton path="status" class="form-check-input"
													id="validationFormCheck1" name="radio-stacked"
	...
	<script type="text/javascript">
		function add_more() {
			let innerHTML = ``;
			var price_dt = parseInt(sessionStorage.getItem("price_dt"));
			var sale_price_dt = parseInt(sessionStorage.getItem("sale_price_dt"));
			for(let i=1; i<100; i++){
				if(sale_price_dt==null || price_dt ==null){
					sale_price_dt =i;
					price_dt = i;
				}else{
					price_dt +=i;
				...
				innerHTML += `<div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							...
							innerHTML += sale_price_dt;
							innerHTML +=`"
							" class="form-control"
								id="inputEnterYourTitle" placeholder="Enter sale price..."></input>
						</div>
					</div>`;
					if(sessionStorage.getItem("sale_price_dt")==null){
						sessionStorage.setItem("sale_price_dt", i);
						sessionStorage.setItem("price_dt", i);
					}else{
						sessionStorage.setItem("sale_price_dt", sale_price_dt);
						sessionStorage.setItem("price_dt", price_dt);
					}
				i++;
				break;
			}
