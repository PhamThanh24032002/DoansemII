...
<title>Product Detail | ${product_found.name}</title>
</head>
<body>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Product
									detail</li>
								<li class="breadcrumb-item active" aria-current="page">${product_found.name}</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Product detail</h5>
									</div>
									<hr />
									<div class="row mb-3">
										<div class="col-sm-9">
											<input value="${product_found.name}">
										</div>
									</div>
								</div>
							</div>
